...
const PRODUCTS = [
  { id: 'p1', name: 'Nike Air Forces 1', price: 3000, stock: 9,
  ...
  { id: 'p5', name: 'Puma Running Shoe', price: 2099, stock: 20,
  ...
  { id: 'p6', name: 'Puma Sportswear', price: 1212, stock: 15,
  ...
  { id: 'p7', name: 'Reebok Classic', price: 2220, stock: 25,
  ...
  { id: 'p8', name: 'Reebok Fitness Gear', price: 1510, stock: 42,
